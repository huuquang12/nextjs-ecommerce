        ...
        <Grid item md={9}>
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              ...
              <NativeSelect value={sort} onChange={sortHandler}>
...
export async function getServerSideProps({ query }) {
  ...
  const res = await fetch(
    `http://localhost:8000/api/products/search?category=${category}&brand=${brand}&query=${searchQuery}&price=${price}&rating=${rating}&sort=${sort}&page=${page}`
  );
